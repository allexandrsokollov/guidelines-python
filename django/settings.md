...
- secrets and environment-dependent values are read from env, not hardcoded
- critical secrets have no safe default (fail fast)
- env value types are converted explicitly in the settings module
- settings are split into titled sections by domain
